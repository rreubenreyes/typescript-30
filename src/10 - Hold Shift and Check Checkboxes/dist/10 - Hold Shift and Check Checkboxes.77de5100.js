...
function () {
  function ModifierState() {
    this._isMultiEnabled = false;
  }

  Object.defineProperty(ModifierState.prototype, "isMultiEnabled", {
    get: function get() {
  ...
  Object.defineProperty(ModifierState.prototype, "lastChecked", {
    get: function get() {
...
function handleModifierKeyDown(_a) {
...
function handleModifierKeyUp(_a) {
  var keyCode = _a.keyCode;
...
function handleClick() {
  if (state.isMultiEnabled) {
    var lastCheckedIndex = state.lastChecked;
    var index = parseInt(this.dataset.index, 10);

    var _a = [lastCheckedIndex, index].sort(),
        min_1 = _a[0],
        max_1 = _a[1];

    checkboxes.forEach(function (checkbox) {
      var i = parseInt(checkbox.dataset.index, 10);
...
//# sourceMappingURL=/10%20-%20Hold%20Shift%20and%20Check%20Checkboxes.77de5100.map