...
function handleKeyDown(_a) {
  ...
  var dataQuery = "[data-key=\"" + keyCode + "\"]";
  var audio = document.querySelector("audio" + dataQuery);
  var key = document.querySelector("div" + dataQuery);
  audio.currentTime = 0;
  audio.play();
...
//# sourceMappingURL=/01%20-%20JavaScript%20Drum%20Kit.77de5100.map