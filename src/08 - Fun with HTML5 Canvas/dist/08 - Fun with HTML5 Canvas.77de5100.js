...
function draw(_a) {
  ...
  ctx.stroke();
  _b = [offsetX, offsetY], state.lastX = _b[0], state.lastY = _b[1]; // line endpoint
}
/* handlers */


function handleMouseDown(_a) {
  var offsetX = _a.offsetX,
      offsetY = _a.offsetY;
  ...
  _b = [offsetX, offsetY], state.lastX = _b[0], state.lastY = _b[1];
}
/* listeners */
...
//# sourceMappingURL=/08%20-%20Fun%20with%20HTML5%20Canvas.77de5100.map