...
var secretCode = 'poopmypants';
var keyBuffer = Array(secretCode.length);

var writeToBuffer = function writeToBuffer(_a) {
  var key = _a.key;
  keyBuffer.shift();
  keyBuffer.push(key);
};
...
//# sourceMappingURL=/12%20-%20Key%20Sequence%20Detection.77de5100.map