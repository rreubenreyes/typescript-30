...
var getCitiesData = function getCitiesData() {
  return __awaiter(_this, void 0, Promise, function () {
    var endpoint, citiesRes, citiesJson;
...
var cities = [];
getCitiesData().then(function (citiesData) {
  cities.push.apply(cities, citiesData);
});
/* elements */
...
function findMatches(wordToMatch, citiesData) {
  return citiesData.filter(function (place) {
...
//# sourceMappingURL=/06%20-%20Type%20Ahead.77de5100.map