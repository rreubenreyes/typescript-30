...
var progressSpace = document.querySelector(".progress");
...
function scrub(_a) {
  ...
  var scrubTime = offsetX / progressSpace.offsetWidth * video.duration;
...
progressSpace.addEventListener('mousedown', function () {
  mousedown = true;
});
progressSpace.addEventListener('mouseup', function () {
  mousedown = false;
});
progressSpace.addEventListener('mousemove', function (e) {
  mousedown && scrub(e);
});
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts.ts"], null)
//# sourceMappingURL=/scripts.d4807c70.map